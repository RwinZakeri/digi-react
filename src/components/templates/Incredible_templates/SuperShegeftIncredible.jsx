...
function SuperShegeftIncredible() {
  return (
    <div className="w-11/12 2xl:w-11/12 flex flex-col h-[130px] xl:h-[100px] lg:flex-row justify-between items-start lg:items-center mx-auto h-[110px] bg-[#EBEDED] my-6 rounded-2xl px-6">
...
export default SuperShegeftIncredible;
